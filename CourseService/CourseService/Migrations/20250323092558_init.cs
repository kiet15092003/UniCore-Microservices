        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHavePracticeClass = table.Column<bool>(type: "bit", nullable: false),
                    IsUseForCalculateScore = table.Column<bool>(type: "bit", nullable: false),
                    MinCreditCanApply = table.Column<int>(type: "int", nullable: true),
                    MajorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CompulsoryCourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ParallelCourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
